...
normal-exe:     file format elf64-x86-64
...
0000000000001750 <main>:
    ...
    176d:	8b 35 65 22 00 00    	mov    0x2265(%rip),%esi        # 39d8 <varstandsforvideoassistantrefereee>
    ...
    1787:	e8 94 ff ff ff       	call   1720 <my_function>
